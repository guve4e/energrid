...
export type DeviceExecutionStageName =
  | 'requested'
  | 'published'
  | 'reported'
  | 'verified'
...
export type DeviceExecutionStageStatus =
  | 'complete'
  | 'active'
  | 'failed'
  | 'warning';

export interface DeviceExecutionTraceStage {
  stage: DeviceExecutionStageName;
  status: DeviceExecutionStageStatus;
  observedAt: string;
  message: string;
